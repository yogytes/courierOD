package com.yogytes.launch.cod;
...
public class CODServer {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException, InterruptedException {
        ...
        final Application application = Application.builder(ResourceConfig.builder().packages(CODServer.class.getPackage().getName()).build()).build();
